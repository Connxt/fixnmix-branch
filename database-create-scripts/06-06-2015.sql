...
-- Dumping data for table fixnmix_branch.items: ~0 rows (approximately)
...
-- Dumping data for table fixnmix_branch.settings: ~0 rows (approximately)
...
-- Dumping data for table fixnmix_branch.users: ~0 rows (approximately)
...
INSERT INTO `users` (`id`, `username`, `password`, `user_level_id`, `last_name`, `first_name`, `middle_name`, `created_at`, `updated_at`) VALUES
	(1, 'administrator', 'administrator', 1, 'Felipe', 'Ryan', 'Malicay', '2015-06-06 15:25:00', '2015-06-06 15:25:00');
...
-- Dumping data for table fixnmix_branch.user_levels: ~0 rows (approximately)
